...
public class Lesson01Quiz02RestController {
	...
	public List<User> quiz02_2() {
		...
		user.setTitle("헐 대박");
		user.setUser("bada");
		user.setContent("오늘 목요일이었어... 금요일인줄");
		list.add(user);
		
		user = new User();
		user.setTitle("오늘 데이트 한 이야기 해드릴게요.");
	...
	@RequestMapping("/3")
	public ResponseEntity<User> quiz02_3() {
		User user = new User();
		user.setTitle("안녕하세요 가입인사 드립니다.");
		user.setUser("marobiana");
		user.setContent("안녕하세요. 가입했어요. 앞으로 잘 부탁 드립니다.");
